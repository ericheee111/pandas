...
def set_use_boostkit_fastpaths(value: bool) -> None: ...
...
def ismember_float64_zero_range(
    arr: npt.NDArray[np.float64], upper: int
) -> npt.NDArray[np.bool_]: ...
def unique_float64_monotonic(
...
def unique_float64_masked_monotonic_tail(
    values: npt.NDArray[np.float64], mask: npt.NDArray[np.uint8]
) -> tuple[npt.NDArray[np.float64], npt.NDArray[np.bool_]] | None: ...
