...
"""Self-contained 950 aggregate benchmarks for join_merge."""
...
# ---- Inlined official source: join_merge ----
import string
import numpy as np
...
class _Official_join_merge_Concat:
    params = [0, 1]
    param_names = ['axis']
...
class _Official_join_merge_ConcatDataFrames:
...
class _Official_join_merge_ConcatIndexDtype:
...
class _Official_join_merge_Join:
    params = [True, False]
    param_names = ['sort']
...
class _Official_join_merge_JoinIndex:
...
class _Official_join_merge_JoinMultiindexSubset:
...
class _Official_join_merge_JoinEmpty:
...
class _Official_join_merge_JoinNonUnique:
...
class _Official_join_merge_Merge:
    params = [True, False]
    param_names = ['sort']
...
class _Official_join_merge_MergeEA:
...
class _Official_join_merge_I8Merge:
...
class _Official_join_merge_UniqueMerge:
...
class _Official_join_merge_MergeDatetime:
...
class _Official_join_merge_MergeCategoricals:
...
class _Official_join_merge_MergeOrdered:
...
class _Official_join_merge_MergeAsof:
...
class _Official_join_merge_MergeMultiIndex:
...
class _Official_join_merge_Align:
...
class Merge(_AggregateBenchmark):
    """Aggregate join_merge.Merge with frozen 950 weights."""

    case_params = (
        _select_case_params(_Official_join_merge_Merge, 'time_merge_dataframes_cross', (1,)),  # join_merge.Merge.time_merge_dataframes_cross(False)
        _select_case_params(_Official_join_merge_Merge, 'time_merge_dataframes_cross', (0,)),  # join_merge.Merge.time_merge_dataframes_cross(True)
    )
    run_repeat = (
        1,  # join_merge.Merge.time_merge_dataframes_cross(False)
        1,  # join_merge.Merge.time_merge_dataframes_cross(True)
    )
    case_methods = (
        'time_merge_dataframes_cross',
        'time_merge_dataframes_cross',
    )
    case_types = (_Official_join_merge_Merge, _Official_join_merge_Merge,)


class MergeEA(_AggregateBenchmark):
    """Aggregate join_merge.MergeEA with frozen 950 weights."""

    case_params = (
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (7, 1)),  # join_merge.MergeEA.time_merge('Float32', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (7, 0)),  # join_merge.MergeEA.time_merge('Float32', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (6, 1)),  # join_merge.MergeEA.time_merge('Float64', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (6, 0)),  # join_merge.MergeEA.time_merge('Float64', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (2, 1)),  # join_merge.MergeEA.time_merge('Int16', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (2, 0)),  # join_merge.MergeEA.time_merge('Int16', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (1, 1)),  # join_merge.MergeEA.time_merge('Int32', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (1, 0)),  # join_merge.MergeEA.time_merge('Int32', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (0, 1)),  # join_merge.MergeEA.time_merge('Int64', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (0, 0)),  # join_merge.MergeEA.time_merge('Int64', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (5, 1)),  # join_merge.MergeEA.time_merge('UInt16', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (5, 0)),  # join_merge.MergeEA.time_merge('UInt16', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (4, 1)),  # join_merge.MergeEA.time_merge('UInt32', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (4, 0)),  # join_merge.MergeEA.time_merge('UInt32', True)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (3, 1)),  # join_merge.MergeEA.time_merge('UInt64', False)
        _select_case_params(_Official_join_merge_MergeEA, 'time_merge', (3, 0)),  # join_merge.MergeEA.time_merge('UInt64', True)
    )
    run_repeat = (
        1,  # join_merge.MergeEA.time_merge('Float32', False)
        1,  # join_merge.MergeEA.time_merge('Float32', True)
        1,  # join_merge.MergeEA.time_merge('Float64', False)
        1,  # join_merge.MergeEA.time_merge('Float64', True)
        1,  # join_merge.MergeEA.time_merge('Int16', False)
        1,  # join_merge.MergeEA.time_merge('Int16', True)
        1,  # join_merge.MergeEA.time_merge('Int32', False)
        1,  # join_merge.MergeEA.time_merge('Int32', True)
        1,  # join_merge.MergeEA.time_merge('Int64', False)
        1,  # join_merge.MergeEA.time_merge('Int64', True)
        1,  # join_merge.MergeEA.time_merge('UInt16', False)
        1,  # join_merge.MergeEA.time_merge('UInt16', True)
        1,  # join_merge.MergeEA.time_merge('UInt32', False)
        1,  # join_merge.MergeEA.time_merge('UInt32', True)
        1,  # join_merge.MergeEA.time_merge('UInt64', False)
        1,  # join_merge.MergeEA.time_merge('UInt64', True)
    )
    case_methods = (
        'time_merge',
        'time_merge',
    ...
    case_types = (_Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA, _Official_join_merge_MergeEA,)
