...
"""Self-contained 950 aggregate benchmarks for indexing."""
...
# ---- Inlined official source: indexing ----
from datetime import datetime
import warnings
import numpy as np
from pandas import NA, CategoricalIndex, DataFrame, Index, IntervalIndex, MultiIndex, Series, concat, date_range, option_context, period_range

class _Official_indexing_NumericSeriesIndexing:
    params = [(np.int64, np.uint64, np.float64), ('unique_monotonic_inc', 'nonunique_monotonic_inc')]
    param_names = ['dtype', 'index_structure']

    def setup(self, dtype, index_structure):
        N = 10 ** 6
        indices = {'unique_monotonic_inc': Index(range(N), dtype=dtype), 'nonunique_monotonic_inc': Index([*list(range(55)), 54, *list(range(55, N - 1))], dtype=dtype)}
...
class _Official_indexing_NumericMaskedIndexing:
    monotonic_list = list(range(10 ** 6))
    non_monotonic_list = [*list(range(50)), 54, 53, 52, 51, *list(range(55, 10 ** 6 - 1))]
    params = [('Int64', 'UInt64', 'Float64'), (True, False)]
    param_names = ['dtype', 'monotonic']

    def setup(self, dtype, monotonic):
        indices = {True: Index(self.monotonic_list, dtype=dtype), False: Index(self.non_monotonic_list, dtype=dtype).append(Index([NA], dtype=dtype))}
        self.data = indices[monotonic]
        self.indexer = np.arange(300, 1000)
...
class _Official_indexing_NonNumericSeriesIndexing:
...
class _Official_indexing_DataFrameStringIndexing:
...
class _Official_indexing_DataFrameNumericIndexing:
    params = [(np.int64, np.uint64, np.float64), ('unique_monotonic_inc', 'nonunique_monotonic_inc')]
    param_names = ['dtype', 'index_structure']
...
class _Official_indexing_Take:
    params = ['int', 'datetime']
    param_names = ['index']

    def setup(self, index):
        N = 100000
        indexes = {'int': Index(np.arange(N), dtype=np.int64), 'datetime': date_range('2011-01-01', freq='s', periods=N)}
        index = indexes[index]
        self.s = Series(np.random.rand(N), index=index)
...
class _Official_indexing_MultiIndexing:
    params = [True, False]
...
class _Official_indexing_IntervalIndexing:
...
class _Official_indexing_DatetimeIndexIndexing:
...
class _Official_indexing_SortedAndUnsortedDatetimeIndexLoc:
...
class _Official_indexing_CategoricalIndexIndexing:
...
class _Official_indexing_MethodLookup:
...
class _Official_indexing_GetItemSingleColumn:
...
class _Official_indexing_IndexSingleRow:
    params = [True, False]
...
class _Official_indexing_AssignTimeseriesIndex:
...
class _Official_indexing_InsertColumns:
    ...
    def time_insert_middle(self):
        for i in range(100):
            self.df2.insert(1, 'colname', np.random.randn(self.N), allow_duplicates=True)
...
class _Official_indexing_Setitem:
...
class _Official_indexing_SetitemObjectDtype:
...
class _Official_indexing_ChainIndexing:
    params = [None, 'warn']
    param_names = ['mode']
...
class _Official_indexing_Block:

    def setup(self):
        self.df = DataFrame(False, columns=np.arange(500).astype(str), index=date_range('2010-01-01', '2011-01-01'))
...
class DataFrameNumericIndexing(_AggregateBenchmark):
    """Aggregate indexing.DataFrameNumericIndexing with frozen 950 weights."""

    case_params = (
        _select_case_params(_Official_indexing_DataFrameNumericIndexing, 'time_bool_indexer', (2, 1)),  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.float64'>, 'nonunique_monotonic_inc')
        _select_case_params(_Official_indexing_DataFrameNumericIndexing, 'time_bool_indexer', (2, 0)),  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.float64'>, 'unique_monotonic_inc')
        _select_case_params(_Official_indexing_DataFrameNumericIndexing, 'time_bool_indexer', (0, 1)),  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.int64'>, 'nonunique_monotonic_inc')
        _select_case_params(_Official_indexing_DataFrameNumericIndexing, 'time_bool_indexer', (0, 0)),  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.int64'>, 'unique_monotonic_inc')
        _select_case_params(_Official_indexing_DataFrameNumericIndexing, 'time_bool_indexer', (1, 1)),  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.uint64'>, 'nonunique_monotonic_inc')
        _select_case_params(_Official_indexing_DataFrameNumericIndexing, 'time_bool_indexer', (1, 0)),  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.uint64'>, 'unique_monotonic_inc')
    )
    run_repeat = (
        1,  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.float64'>, 'nonunique_monotonic_inc')
        1,  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.float64'>, 'unique_monotonic_inc')
        1,  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.int64'>, 'nonunique_monotonic_inc')
        1,  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.int64'>, 'unique_monotonic_inc')
        1,  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.uint64'>, 'nonunique_monotonic_inc')
        1,  # indexing.DataFrameNumericIndexing.time_bool_indexer(<class 'numpy.uint64'>, 'unique_monotonic_inc')
    )
    case_methods = (
        'time_bool_indexer',
        'time_bool_indexer',
    ...
    case_types = (_Official_indexing_DataFrameNumericIndexing, _Official_indexing_DataFrameNumericIndexing, _Official_indexing_DataFrameNumericIndexing, _Official_indexing_DataFrameNumericIndexing, _Official_indexing_DataFrameNumericIndexing, _Official_indexing_DataFrameNumericIndexing,)
