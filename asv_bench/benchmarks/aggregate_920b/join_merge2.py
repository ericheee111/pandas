...
"""Self-contained 920b aggregate benchmarks for join_merge."""
...
class ConcatDataFrames(_AggregateBenchmark):
    """Aggregate join_merge.ConcatDataFrames with frozen 920b weights."""

    case_params = (
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_c_ordered', (0, 1)),  # join_merge.ConcatDataFrames.time_c_ordered(0, False)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_c_ordered', (0, 0)),  # join_merge.ConcatDataFrames.time_c_ordered(0, True)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_c_ordered', (1, 1)),  # join_merge.ConcatDataFrames.time_c_ordered(1, False)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_c_ordered', (1, 0)),  # join_merge.ConcatDataFrames.time_c_ordered(1, True)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_f_ordered', (0, 1)),  # join_merge.ConcatDataFrames.time_f_ordered(0, False)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_f_ordered', (0, 0)),  # join_merge.ConcatDataFrames.time_f_ordered(0, True)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_f_ordered', (1, 1)),  # join_merge.ConcatDataFrames.time_f_ordered(1, False)
        _select_case_params(_Official_join_merge_ConcatDataFrames, 'time_f_ordered', (1, 0)),  # join_merge.ConcatDataFrames.time_f_ordered(1, True)
    )
    run_repeat = (
        1,  # join_merge.ConcatDataFrames.time_c_ordered(0, False)
        1,  # join_merge.ConcatDataFrames.time_c_ordered(0, True)
        112,  # join_merge.ConcatDataFrames.time_c_ordered(1, False)
        150,  # join_merge.ConcatDataFrames.time_c_ordered(1, True)
        1,  # join_merge.ConcatDataFrames.time_f_ordered(0, False)
        1,  # join_merge.ConcatDataFrames.time_f_ordered(0, True)
        112,  # join_merge.ConcatDataFrames.time_f_ordered(1, False)
        150,  # join_merge.ConcatDataFrames.time_f_ordered(1, True)
    )
    case_methods = (
        'time_c_ordered',
        'time_c_ordered',
    ...
    case_types = (_Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames, _Official_join_merge_ConcatDataFrames,)


class I8Merge(_AggregateBenchmark):
    """Aggregate join_merge.I8Merge with frozen 920b weights."""

    case_params = (
        _select_case_params(_Official_join_merge_I8Merge, 'time_i8merge', (0,)),  # join_merge.I8Merge.time_i8merge('inner')
...
class MergeCategoricals(_AggregateBenchmark):
    """Aggregate join_merge.MergeCategoricals with frozen 920b weights."""

    case_params = (
        _select_case_params(_Official_join_merge_MergeCategoricals, 'time_merge_cat', ()),  # join_merge.MergeCategoricals.time_merge_cat
        _select_case_params(_Official_join_merge_MergeCategoricals, 'time_merge_object', ()),  # join_merge.MergeCategoricals.time_merge_object
        _select_case_params(_Official_join_merge_MergeCategoricals, 'time_merge_on_cat_col', ()),  # join_merge.MergeCategoricals.time_merge_on_cat_col
        _select_case_params(_Official_join_merge_MergeCategoricals, 'time_merge_on_cat_idx', ()),  # join_merge.MergeCategoricals.time_merge_on_cat_idx
    )
    run_repeat = (
        2,  # join_merge.MergeCategoricals.time_merge_cat
        1,  # join_merge.MergeCategoricals.time_merge_object
        1,  # join_merge.MergeCategoricals.time_merge_on_cat_col
        1,  # join_merge.MergeCategoricals.time_merge_on_cat_idx
    )
    case_methods = (
        'time_merge_cat',
        'time_merge_object',
        'time_merge_on_cat_col',
