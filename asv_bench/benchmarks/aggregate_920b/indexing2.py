...
"""Self-contained 920b aggregate benchmarks for indexing."""
...
class NumericSeriesIndexing(_AggregateBenchmark):
    ...
    case_params = (
        _select_case_params(_Official_indexing_NumericSeriesIndexing, 'time_iloc_scalar', (2, 1)),  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.float64'>, 'nonunique_monotonic_inc')
        _select_case_params(_Official_indexing_NumericSeriesIndexing, 'time_iloc_scalar', (2, 0)),  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.float64'>, 'unique_monotonic_inc')
        _select_case_params(_Official_indexing_NumericSeriesIndexing, 'time_iloc_scalar', (0, 1)),  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.int64'>, 'nonunique_monotonic_inc')
        _select_case_params(_Official_indexing_NumericSeriesIndexing, 'time_iloc_scalar', (0, 0)),  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.int64'>, 'unique_monotonic_inc')
    )
    run_repeat = (
        1,  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.float64'>, 'nonunique_monotonic_inc')
        1,  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.float64'>, 'unique_monotonic_inc')
        1,  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.int64'>, 'nonunique_monotonic_inc')
        1,  # indexing.NumericSeriesIndexing.time_iloc_scalar(<class 'numpy.int64'>, 'unique_monotonic_inc')
    )
    case_methods = (
        'time_iloc_scalar',
        'time_iloc_scalar',
    ...
    case_types = (_Official_indexing_NumericSeriesIndexing, _Official_indexing_NumericSeriesIndexing, _Official_indexing_NumericSeriesIndexing, _Official_indexing_NumericSeriesIndexing,)
