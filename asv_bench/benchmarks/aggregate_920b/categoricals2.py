...
"""Self-contained 920b aggregate benchmarks for categoricals."""
...
class Constructor(_AggregateBenchmark):
    """Aggregate categoricals.Constructor with frozen 920b weights."""

    case_params = (
        _select_case_params(_Official_categoricals_Constructor, 'time_existing_categorical', ()),  # categoricals.Constructor.time_existing_categorical
        _select_case_params(_Official_categoricals_Constructor, 'time_existing_series', ()),  # categoricals.Constructor.time_existing_series
        _select_case_params(_Official_categoricals_Constructor, 'time_with_nan', ()),  # categoricals.Constructor.time_with_nan
    )
    run_repeat = (
        3475,  # categoricals.Constructor.time_existing_categorical
        3233,  # categoricals.Constructor.time_existing_series
        1,  # categoricals.Constructor.time_with_nan
    )
    case_methods = (
