...
"""Self-contained 920b aggregate benchmarks for groupby."""
...
class GroupByCythonAgg(_AggregateBenchmark):
    ...
    case_params = (
        _select_case_params(_Official_groupby_GroupByCythonAgg, 'time_frame_agg', (0, 3)),  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'max')
        _select_case_params(_Official_groupby_GroupByCythonAgg, 'time_frame_agg', (0, 6)),  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'mean')
        _select_case_params(_Official_groupby_GroupByCythonAgg, 'time_frame_agg', (0, 2)),  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'min')
        _select_case_params(_Official_groupby_GroupByCythonAgg, 'time_frame_agg', (0, 0)),  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'sum')
    )
    run_repeat = (
        1,  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'max')
        1,  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'mean')
        1,  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'min')
        1,  # groupby.GroupByCythonAgg.time_frame_agg('float64', 'sum')
    )
    case_methods = (
        'time_frame_agg',
        'time_frame_agg',
...
class GroupByCythonAggEaDtypes(_AggregateBenchmark):
    ...
    case_params = (
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (0, 3)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'max')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (0, 4)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'mean')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (0, 2)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'min')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (0, 0)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'sum')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (1, 3)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'max')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (1, 4)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'mean')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (1, 2)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'min')
        _select_case_params(_Official_groupby_GroupByCythonAggEaDtypes, 'time_frame_agg', (1, 0)),  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'sum')
    )
    run_repeat = (
        2,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'max')
        2,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'mean')
        2,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'min')
        2,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Float64', 'sum')
        1,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'max')
        1,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'mean')
        1,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'min')
        1,  # groupby.GroupByCythonAggEaDtypes.time_frame_agg('Int64', 'sum')
    )
    case_methods = (
        'time_frame_agg',
        'time_frame_agg',
...
class GroupByMethods(_AggregateBenchmark):
    ...
    case_params = (
        ...
        _select_case_params(_Official_groupby_GroupByMethods, 'time_dtype_as_group', (2, 29, 0, 0, 0)),  # groupby.GroupByMethods.time_dtype_as_group('float', 'sum', 'direct', 1, 'cython')
        _select_case_params(_Official_groupby_GroupByMethods, 'time_dtype_as_group', (0, 3, 0, 0, 0)),  # groupby.GroupByMethods.time_dtype_as_group('int', 'count', 'direct', 1, 'cython')
        _select_case_params(_Official_groupby_GroupByMethods, 'time_dtype_as_group', (0, 18, 0, 0, 0)),  # groupby.GroupByMethods.time_dtype_as_group('int', 'mean', 'direct', 1, 'cython')
        _select_case_params(_Official_groupby_GroupByMethods, 'time_dtype_as_group', (0, 19, 0, 0, 0)),  # groupby.GroupByMethods.time_dtype_as_group('int', 'nunique', 'direct', 1, 'cython')
        _select_case_params(_Official_groupby_GroupByMethods, 'time_dtype_as_group', (0, 29, 0, 0, 0)),  # groupby.GroupByMethods.time_dtype_as_group('int', 'sum', 'direct', 1, 'cython')
        _select_case_params(_Official_groupby_GroupByMethods, 'time_dtype_as_group', (3, 3, 0, 0, 0)),  # groupby.GroupByMethods.time_dtype_as_group('object', 'count', 'direct', 1, 'cython')
    ...
    run_repeat = (
        ...
        2,  # groupby.GroupByMethods.time_dtype_as_group('float', 'sum', 'direct', 1, 'cython')
        5,  # groupby.GroupByMethods.time_dtype_as_group('int', 'count', 'direct', 1, 'cython')
        2,  # groupby.GroupByMethods.time_dtype_as_group('int', 'mean', 'direct', 1, 'cython')
        1,  # groupby.GroupByMethods.time_dtype_as_group('int', 'nunique', 'direct', 1, 'cython')
        2,  # groupby.GroupByMethods.time_dtype_as_group('int', 'sum', 'direct', 1, 'cython')
        5,  # groupby.GroupByMethods.time_dtype_as_group('object', 'count', 'direct', 1, 'cython')
